...
if Session("pr_username")="" then
	response.Redirect("admin.asp")
	  ...
	  Set rsUser1 = NewConnection.Execute("update tbl_pr_mpreminder set re_status='Yes',done_date='" & request("txt_date") & "',done_remark='" & request("txt_remark") & "' where srno='" & request("srno") & "'")
