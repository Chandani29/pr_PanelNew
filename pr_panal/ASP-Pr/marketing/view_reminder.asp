...
<%
		...
		strsql1 = "select * from tbl_pr_mpreminder where re_status='Yes' and mp_id='" & trim(session("MarketingName")) & "' order by srno desc"
...
<table width="800" border="1" cellspacing="2" cellpadding="1"> 
  <tr align="center"> 
    <td colspan="6" class="txt"><strong class="Tab2">&nbsp;</strong><br>
      Done Reminders (<%=trim(session("MarketingName"))%>)</td>
  </tr>
  <tr> 
