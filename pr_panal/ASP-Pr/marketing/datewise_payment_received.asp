  ...
  <tr> 
    <td height="140" valign="top"> <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <%
		...
		if(request("text_date_from24") = "" or request("text_date_to24") = "") then
    ...
    <table width="70%" border="1" cellpadding="3" cellspacing="1" class="Tab2" align="center"><form action="market_entry_cal.asp" method="post" name="frm_report">
        <tr valign="top" class="tdrow3">
          <td colspan="17" class="tdrow5"><strong><a href="project_report_selected.asp"><font size="1" face="Verdana, Arial, Helvetica, sans-serif">Main 
            Page</font></a> &nbsp;&nbsp;</strong></td>
        </tr>
        <tr valign="top" class="Tab3"> 
          <td height="31" colspan="17" align="center" bgcolor="#CCCCCC" class="tdrow5"><strong>Result 
            Found</strong> - <strong><font color="#CC0000" size="2"><%=z%></font></strong> &nbsp;[Payment Received From <%=text_date_from%> To <%=text_date_to%>]</td>
        </tr>
        <tr valign="top" class="bottom" > 
          <td bgcolor="#E6E6E6" class="Tab2"><strong>Project Id&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>
          <td bgcolor="#E6E6E6" class="Tab2"><strong>Proj. Receiving Date</strong></td>
	...
	%>
		...
		%>	
		 ...
		 <% end if %>
				...
				<% end if %>
				<td align="right" class="Tab2"><%=all_total_cast_upper%>&nbsp;</td> 
...
'							end if
		...
		<% if(rsProject("workstatus")="Received" or rsProject("workstatus")="Trial Project") then %>
		 <td class="Tab3" align="right"><%=sum_expenses%><br><a href="proj_expenses.asp?srno=<%=rsProject("srno")%>"><strong>Expense</strong></a>&nbsp;</td>
		 <% else %>
		 <td class="Tab3" align="right"><%=sum_expenses%><br><a href="proj_expenses_history.asp?srno=<%=rsProject("srno")%>"><strong>History</strong></a>&nbsp;</td>
		 <% end if %>
        ...
        <%
					...
					i=i+1
				loop
				total_balance = round((total_cost - total_bal_cost_sub - total_expenses),2)
		%>
        <tr valign="top" class="tb2" > 
          <td colspan="4" align="right" bgcolor="#E6E6E6" class="Tab2"><strong>Total</strong></td>
		  ...
		  <td align="right" bgcolor="#E6E6E6" class="Tab2"><%=round(total_balance,2)%>&nbsp;</td>		   
		  ...
		  <td  colspan="2" align="right" bgcolor="#E6E6E6" class="Tab2">&nbsp;</td>
        </tr>
		<tr valign="top" class="tb2" > 
          <td colspan="5" align="right" bgcolor="#E6E6E6" class="Tab2"><strong>Balance 
            Payment</strong></td>
          <td colspan="2" align="right" bgcolor="#E6E6E6" class="Tab2"><%=round((total_payment_received + total_balance),2)%></td>
	...
	<% 
		''''''''''''''''''''''''''''''''' start Payment Received then '''''''''''''''''''''		
	%>
	<br>
	
	 <table width="70%" border="1" cellpadding="3" cellspacing="1" class="Tab2" align="center">
        <%
			dim rsProjectPartial
			dim rsProjPartial
			set rsProjPartial = server.CreateObject("adodb.recordset")
			set rsProjectPartial = server.CreateObject("adodb.recordset")
			partsql = "SELECT * from tbl_pr_project where mp_id='"& trim(session("MarketingName")) & "' and workstatus='Received' order by srNo desc"
			rsProjectPartial.open partsql,NewConnection
			if rsProjectPartial.eof or rsProjectPartial.bof then
				Response.Write("<strong><font color=red>No Record Found!!</font></strong>")
			else				
				'response.Write(z)
		%>		 
        <tr valign="top" class="Tab3"> 
          <td height="31" colspan="17" align="center" bgcolor="#CCCCCC" class="tdrow5"><strong>Partial Payment</strong> Received From <%=text_date_from%> To <%=text_date_to%></td>
        </tr>
		<tr valign="top" class="bottom" > 
          <td bgcolor="#E6E6E6" class="Tab2"><strong>Project&nbsp;Id&nbsp;&nbsp;</strong></td>
		  <td bgcolor="#E6E6E6" class="Tab2"><strong>Project&nbsp;Name&nbsp;</strong></td>
        ...
        <td bgcolor="#E6E6E6" class="Tab2"><strong>Project&nbsp;Cost&nbsp;(INR)</strong></td>
        <td bgcolor="#E6E6E6" class="Tab2"><strong>Payment Received (INR)</strong></td>
		</tr> 
		<% 
			   do while not rsProjectPartial.eof 
			   partPaysql = "SELECT sum(p_payment) as sumparttial from tbl_pr_partial_payment where proj_id='"& trim(rsProjectPartial("srNo")) & "' and ddate between'" & txt_date_From1 &"' and '" & txt_date_To1 & "'"
			   if rsProjPartial.state then rsProjPartial.close
			   rsProjPartial.open partPaysql,NewConnection
				   if (isnull(rsProjPartial("sumparttial")) or rsProjPartial("sumparttial")="" or rsProjPartial("sumparttial")=0) then
				   else				   
				   'response.Write(partPaysql)
		%>
		   <tr valign="top" class="bottom" >           
			   <td bgcolor="#E6E6E6" class="Tab3"><a href="project_Details_selected.asp?refno=<%=rsProjectPartial("srno")%>&total_id=<%=rsProjectPartial("proj_id")%>" target="_blank"><font color="#0000FF"><%=rsProjectPartial("proj_id")%></font></a></td>
			   <td bgcolor="#E6E6E6" class="Tab3"><%=rsProjectPartial("proj_name")%>&nbsp;</td>
			   <td bgcolor="#E6E6E6" class="Tab3"><%=rsProjectPartial("type_proj")%>&nbsp;</td>
			   <td bgcolor="#E6E6E6" class="Tab3"><%=rsProjectPartial("cost")%>&nbsp;</td>
			   <td bgcolor="#E6E6E6" class="Tab3"><%=round(rsProjPartial("sumparttial"),2)%><br><strong><a href="payment_history.asp?srno=<%=rsProjectPartial("srno")%>">P.&nbsp;History</a></strong>&nbsp;</td>
		   </tr>
		 <%		 	total_partial_payment = round((total_partial_payment + rsProjPartial("sumparttial")),2)
					end if
				rsProjectPartial.movenext
				loop
		%>
		 <tr valign="top" class="bottom" >     
		 	<td bgcolor="#E6E6E6" align="right" colspan="4" class="Tab2">Total&nbsp;</td>
			<td bgcolor="#E6E6E6" class="Tab2"><%=round(total_partial_payment,2)%>&nbsp;</td>
		 </tr>
	</table>
	<%
			end if 
		''''''''''''''''''''''''''''''''' end of Payment Received then '''''''''''''''''''''
	%>			  
	<br>	  
<table width="100%" border="0" cellpadding="0" cellspacing="0">
