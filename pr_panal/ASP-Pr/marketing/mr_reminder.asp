...
<%
		...
		strsql1 = "select * from tbl_pr_mpreminder where re_status='No' and mp_id='" & trim(session("MarketingName")) & "' order by srno desc"
...
<form name="re_form" method="post" action="mr_reminder_cal.asp">
  <table width="400" border="1" cellspacing="2" cellpadding="1">
    <tr align="center"> 
