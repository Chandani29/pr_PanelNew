	...
	''''''''''''''''''''''''''' calculating cost of developer ''''''''''''''''''''''''''''''''''''''''''''''''''
	 ...
	 ''''''''''''''''''''''''''''' calculating all information of projects ''''''''''''''''''''''''''''''	
	   ...
	   '''''''''''''''''''''''''' inserting values in table '''''''''''''''''''''''''''''''''''''''''''''''''
		strsql = "insert into tbl_pr_projDetails(proj_id,inhouse_id,asignedby,proj_name,working_per,hourspend,dev_cost,work_remark,ddate)"
		strsql = strsql & "values('" & proj_id & "','" & sub_id & "','" & mp_id & "','" & proj_name & "','" & asigned_per & "','" & totalhour_exp & "','" & dev_cal_cost & "','" & Remark & "','" & ddate & "')"
		'response.Write(strsql)
		set rsproject1 = server.CreateObject("adodb.recordset")
		Set rsproject1 = NewConnection.Execute(strsql)		
		response.Redirect("inhouse_project_report.asp?refno="& proj_id & "")		
%>