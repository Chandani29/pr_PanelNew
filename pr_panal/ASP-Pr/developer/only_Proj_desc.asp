	  ...
	  <br>	
		 <table width="70%" border="1" cellpadding="3" cellspacing="1" class="Tab2" align="center">
		  		<tr valign="top" bgcolor="#E6E6E6" class="tb2" >	
					<td class="Tab2" align="left" bgcolor="#CCCCCC">Project Description of <%=proj_id%>::</td>
				</tr>
		<%	
				call OpenConnection
			dim rsProject
				set rsProject = server.CreateObject("adodb.recordset")
				rsProject.open "SELECT proj_desc from tbl_pr_project where srno='" & proj_srno & "'",NewConnection
				if rsProject.eof or rsProject.bof then					
					...
					do while not rsProject.eof
						...
						tmpText2 = server.HTMLEncode(rsProject("proj_desc"))
		...
		%>				
						<tr valign="top" bgcolor="#E6E6E6" class="tb2" >							
        				<td class="Tab3" align="left"><%=FixForHTML%></td>
						</tr>			
		<%				
					rsProject.movenext
					loop
