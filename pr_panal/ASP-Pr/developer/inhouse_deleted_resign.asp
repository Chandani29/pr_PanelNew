...
<form name="del_form" action="inhouse_delete_workstatus.asp" method="post">
...
<input name="Submit2" type="button" class="Tab2" value="Cancel" style="WIDTH: 150px;" onClick="window.location = 'inhouse_project_report.asp?refno=<%=refno%>';">
</td>
</tr>
</table>
</form>
