...
<%
		...
		strsql1 = "select * from tbl_pr_devreminder where re_status='No' and dev_id='" & trim(session("DeveloperName")) & "' and srno ='" & request("srno") & "'"
...
<form name="re_form" method="post" action="re_done.asp?srno=<%=request("srno")%>">
  <table width="400" border="1" cellspacing="2" cellpadding="1">
    <tr align="center"> 
      <td colspan="2" class="txt">Reminder (<%=trim(session("DeveloperName"))%>)  </td>
    </tr>
	<tr> 
    ...
    <tr> 
      ...
      <td width="185" align="left" class="Tab3"><input name="txt_date" type="text" id="txt_date" size="30" readonly></td>
    </tr>   
    <tr> 
