	  ...
	  <br>	
		 <table width="70%" border="1" cellpadding="3" cellspacing="1" class="Tab2" align="center">
		  		<tr valign="top" bgcolor="#E6E6E6" class="tb2" >	
					<td class="Tab2" colspan="15" align="left" bgcolor="#CCCCCC">Assign task of <font color="#0000FF"><%=proj_id%></font>::</td>
				</tr>
		<%	
				call OpenConnection
			dim rsProject
				set rsProject = server.CreateObject("adodb.recordset")
				rsProject.open "SELECT work_by_mark from tbl_pr_projDetails where srno='" & proj_srno & "'",NewConnection
				if rsProject.eof or rsProject.bof then					
					...
					do while not rsProject.eof
						...
						tmpText2 =  Server.HTMLEncode(rsProject("work_by_mark"))
