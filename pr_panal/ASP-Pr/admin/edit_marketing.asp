...
<%
	call OpenConnection
		Set rsUser = NewConnection.Execute("select * from tbl_pr_marketingLogin where user_id='" & mar_id &"'")
...
<table id="Table_01" width="100%" height="581" border="0" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <table width="38%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="87%" valign="middle" background="images/tabl-cor_02.jpg"><strong><font color="#006699" size="2" face="Verdana, Arial, Helvetica, sans-serif">Marketing 
                  </font></strong></td>
        ...
        <tr>
          <td height="21" valign="top" bgcolor="#727272"><table width="100%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td height="19" bgcolor="#FFFFFF"><form name="form1" ACTION="edit_marketing_cal.asp" Method="post" onSubmit="return checkLogin()">
                    ...
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="3" style="border-collapse: collapse" >
					  ...
					  <tr> 
                        ...
                        <td height="34" width="183"><b><font color="#FF0000"> 
                          <input name="txt_id" size="20" type="text" value='<%=userid%>' readonly>
                          </font></b></td>
                      </tr>
                      <tr> 
                      ...
                      <tr> 
                        <td height="40" width="196"> <div align="left"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Old 
					  ...
					  <tr> 
                        <td height="40" width="196"> <div align="left"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>New 
                            PASSWORD:</b></font></div></td>
                        <td height="40" width="183"><b><font color="#FF0000"> 
