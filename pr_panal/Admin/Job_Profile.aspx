<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Job_Profile.aspx.cs" Inherits="Admin_Default" %>
                ...
                <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="87%" valign="middle" background="../images/tabl-cor_02.jpg"> 
                            <strong><font color="#006699" size="2" face="Verdana, Arial, Helvetica, sans-serif">Job Profile Entry Form</font></strong>
                        </td>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="3" style="border-collapse: collapse">
                                <tr>
                                    <td height="34" width="196">
                                        <div align="left">
                                            <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Job Profile:</b></font>
                                        </div>
                                    </td>
                                    <td height="34">
                                        <b><font color="#ffffff">
                                            <asp:TextBox ID="txt_job" runat="server" size="20"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                                InitialValue="" ValidationGroup="valgroup" Display="Dynamic" ControlToValidate="txt_job"
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td valign="middle" class="Tab3"> 
                        <a href="Job_Profile.aspx?Id=<%# Eval("Id")%>">Edit</a>&nbsp;
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
