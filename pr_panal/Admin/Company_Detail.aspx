<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Company_Detail.aspx.cs" Inherits="Admin_Default" %>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="3" style="border-collapse: collapse">
                                <tr>
                                    <td height="34" width="196">
                                        <div align="left">
                                            <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Company Name:</b></font>
                                        </div>
                                    </td>
                                    <td height="34">
                                        <b><font color="#ffffff">
                                            <asp:TextBox ID="txt_company" runat="server" size="20"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*"
                                                InitialValue="" ValidationGroup="valgroup" Display="Dynamic" ControlToValidate="txt_company"
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td valign="middle" class="Tab3">
                        <a href="Company_Detail.aspx?Id=<%# Eval("Id")%>">Edit</a>&nbsp;
                    </td>
                    <td valign="middle" class="Tab3">
                        <a href="Company_Detail.aspx?del=<%# Eval("Id")%>">Delete</a>&nbsp;
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
