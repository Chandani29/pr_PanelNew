<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="Hr_Interview.aspx.cs" Inherits="Admin_Default" %>
    ...
    <table width="100%" border="1" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" class="Tab2" bgcolor="#CCCCCC">
                        <a href="Reference_Type.aspx" target="_blank">Reference Type&nbsp;</a>
                    </td>
                    <td valign="middle" class="Tab2" bgcolor="#CCCCCC">
                        <a href="Job_Profile.aspx" target="_blank">Job Profile&nbsp;</a>
                    </td>
                    <td valign="middle" class="Tab2" bgcolor="#CCCCCC">
                        <a href="Interviewee.aspx" target="_blank">Interviewee Detail&nbsp;</a> 
                    </td>  
                </tr>
            </table>   
