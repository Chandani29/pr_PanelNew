...
public partial class Marketing_project_details : System.Web.UI.Page
{
            ...
            if (Session["marketing_srno"] != null)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int j = 0; j < ds.Tables[0].Rows.Count; j++)
                    {
                        ...
                        string strsubmeted_on = ds.Tables[0].Rows[j]["submeted_on"].ToString().Replace(" 12:00:00 AM", "");
    ...
    private void bindCostHour()
    {
        try
        {
            if (Session["marketing_srno"] != null)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    string strgetasigned_per = ds.Tables[0].Rows[0]["asigned_per"].ToString();
                    string strgetasigned_per_show = string.Empty;
                    string[] split1 = strgetasigned_per.Split(new char[] { ',' });
                    int arrLenth1 = split1.Length;
                    for (int a = 0; a < arrLenth1; a++)
                    {
                        strgetasigned_per_show += strgetasigned_per_show + "'" + split1[a] + "',";
                    }
                    strgetasigned_per_show = strgetasigned_per_show.Remove(strgetasigned_per_show.Length - 1);

                    DataSet ds6 = dal.retDatasetByquery("SELECT * from tbl_ProjDetails where proj_id='" + Request.QueryString["srno"].ToString().Trim() + "' and working_per IN (" + strgetasigned_per_show.ToString().Trim() + ") and del_status='0' order by working_per asc,srno desc");
                    if (ds6.Tables[0].Rows.Count > 0)
                    {
                        string strCostHour = string.Empty;
                        strCostHour += "<table width='70%' border='1' cellpadding='3' cellspacing='1' class='Tab2' align='center'>";
                        strCostHour += "<tr valign='top' bgcolor='#E6E6E6' class='tdrow3' align='center'>";
                        strCostHour += "<td colspan='14' class='tdrow5' bgcolor='#CCCCCC'>";
                        strCostHour += "<div align='center'><strong>Developer Cost/Hour Calculation</strong></div>";
                        strCostHour += "</td></tr>";
                        strCostHour += "<tr valign='top' bgcolor='#E6E6E6' class='bottom'>";
                        strCostHour += "<td class='Tab2'><strong>Developers&nbsp;</strong></td>";
                        strCostHour += "<td class='Tab2'><strong>Hour Spent</strong></td>";
                        strCostHour += "<td class='Tab2'><strong>Total Cost Per Hr.</strong></td>";
                        strCostHour += "</tr>";
                        ...
                        for (int z = 0; z < arrLenth; z++)
                        {
                            ...
                            if (ds5.Tables[0].Rows.Count > 0)
                            {
                                ...
                                object[] val4 = { "0", ds5.Tables[0].Rows[z]["working_per"].ToString(), "select4" };
                        ...
                        strCostHour += "<tr valign='top' bgcolor='#E6E6E6' class='tb2'>";
                        strCostHour += "<td class='Tab2' align='right' bgcolor='#CCCCCC'>Total&nbsp;</td>";
                        strCostHour += "<td class='Tab2' bgcolor='#CCCCCC'>" + all_total_hour1 + "&nbsp;</td>";
                        strCostHour += "<td class='Tab2' bgcolor='#CCCCCC'>" + all_total_cast1 + "&nbsp;</td>";
                        strCostHour += "</tr></table><br />";
            ...
            if (Session["marketing_srno"] != null)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (ds6.Tables[0].Rows.Count > 0)
                    {
                        ...
                        strDoneAssigned += "<table width='70%' border='1' cellpadding='3' cellspacing='1' class='Tab2' align='center'>";
                        strDoneAssigned += "<tr valign='top' bgcolor='#E6E6E6' class='tdrow3' align='center'>";
                        strDoneAssigned += "<td colspan='14' class='tdrow5' bgcolor='#CCCCCC'>";
                        strDoneAssigned += "<div align='center'><strong>Task Done/Assigned By Developers/Marketing ...</strong></div>";
                        strDoneAssigned += "</td></tr>";
                        ...
                        for (int z = 0; z < arrLenth; z++)
                        {
                            ...
                            if (ds5.Tables[0].Rows.Count > 0)
                            {
                                ...
                                strDoneAssigned += "<td class='Tab2'><strong>Remark</strong></td>";
                                ...
                                for (int j = 0; j < ds5.Tables[0].Rows.Count; j++)                      
                                {
                                    ...
                                    if (class1 == "txt" || class1 == "txtpink" || class1 == "txtdel")
                                    {
                                        strDoneAssigned += "<td class='" + class1 + "'>&nbsp;</td>";   
                                    }
                                    else
                                    {
                                        strDoneAssigned += "<td class='" + class1 + "'><a href='prtial_response.aspx?srno=" + ds5.Tables[0].Rows[j]["srno"] + "'>Remark</a>&nbsp;</td>"; 
                                    }
                                    ...
                                    if (ds5.Tables[0].Rows[j]["delete_remark"].ToString() != "No")
                                        strDoneAssigned += "<td class='txt'>" + ds5.Tables[0].Rows[j]["delete_remark"].ToString() + "&nbsp;</td>";
                                    else
                                        strDoneAssigned += "<td class='" + class1 + "'>&nbsp;</td>";
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (Session["marketing_srno"] != null)
            {
                ...
                DataSet ds5 = dal.retDatasetByquery("SELECT max(srno) as maxid FROM tbl_ProjDetails");
                string strTaskSrno = "AKS-0" + (Convert.ToInt32(ds5.Tables[0].Rows[0]["maxid"].ToString().Trim()) + 1);
