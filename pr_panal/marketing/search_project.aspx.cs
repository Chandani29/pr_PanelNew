...
public partial class Marketing_search_project : System.Web.UI.Page
{
        ...
        try
        {
            if (Session["marketing_srno"] != null)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    object[] val1 = { "0", ds.Tables[0].Rows[0]["user_id"].ToString(), "select10" };
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < ds1.Tables[0].Rows.Count; j++)
                        {
                            ...
                            strInHouseProject += "<td class='Tab3' align='center'>&nbsp;<a href='project_details.aspx?srno=" + ds1.Tables[0].Rows[j]["srno"].ToString() + "' target='_blank'><font color='" + coror1 + "'>" + ds1.Tables[0].Rows[j]["proj_name"].ToString() + "</font></a></td>";
    ...
    private void bindProjectList()
    {
        try
        {
            if (Session["marketing_srno"] != null)
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    if (Request.Cookies["MarketingSearch"]["SelectType"] == null)
                    {
                    ...
                    string roll;
                    roll = Request.Cookies["MarketingSearch"]["SelectType"];
                    roll = roll + "," + Request.Cookies["MarketingSearch"]["ProjectType"];
                    roll = roll + "," + Request.Cookies["MarketingSearch"]["From"];
                    roll = roll + "," + Request.Cookies["MarketingSearch"]["To"];
                    ...
                    if (strProjectType == "")
                    {
                        ...
                        if (strSelectType == "Received" || strSelectType == "Trial Project")
                            ds1 = dal.retDatasetByquery(" SELECT * from tbl_Project WHERE mp_id like '%" + ds.Tables[0].Rows[0]["user_id"].ToString() + "%' and type_proj<>'1' and ddate between'" + strFrom + "' and '" + strTo + "' and workstatus='" + strSelectType + "' order by srNo desc ");

                        if (strSelectType == "Dead" || strSelectType == "Completed")
                            ds1 = dal.retDatasetByquery(" SELECT * from tbl_Project WHERE mp_id like '%" + ds.Tables[0].Rows[0]["user_id"].ToString() + "%' and type_proj<>'1' and completed_on between'" + strFrom + "' and '" + strTo + "' and workstatus='" + strSelectType + "' order by srNo desc ");

                        if (strSelectType == "All")
                            ds1 = dal.retDatasetByquery(" SELECT * from tbl_Project WHERE mp_id like '%" + ds.Tables[0].Rows[0]["user_id"].ToString() + "%' and type_proj<>'1' and ddate between'" + strFrom + "' and '" + strTo + "' order by srNo desc ");
                    }
                    else
                    {
                        ...
                        if (strSelectType == "Project Name")
                            ds1 = dal.retDatasetByquery(" SELECT * from tbl_Project WHERE mp_id like '%" + ds.Tables[0].Rows[0]["user_id"].ToString() + "%' and type_proj<>'1' and proj_name like '" + strProjectType + "%' ");

                        if (strSelectType == "Project ID")
                            ds1 = dal.retDatasetByquery(" SELECT * from tbl_Project WHERE mp_id like '%" + ds.Tables[0].Rows[0]["user_id"].ToString() + "%' and type_proj<>'1' and proj_id ='" + strProjectType + "' ");
                    }
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        for (int j = 0; j < ds1.Tables[0].Rows.Count; j++)
                        {
                            ...
                            strProjectList += "<td class='Tab3' align='center'>&nbsp;<a href='project_details.aspx?srno=" + ds1.Tables[0].Rows[j]["srno"].ToString() + "' target='_blank'><font color='" + coror1 + "'>" + ds1.Tables[0].Rows[j]["proj_name"].ToString() + "</font></a></td>";
