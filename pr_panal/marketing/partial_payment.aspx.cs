...
public partial class Marketing_partial_payment : System.Web.UI.Page
{
    ...
    private void binddatagrid()
    {
        try
        {
            if (Session["marketing_srno"] != null)
            {
                ...
                DataSet ds1 = dal.getDataSet("ManagePartialPayment", col1, val1);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (Session["marketing_srno"] != null)
            {
                string[] col3 = { "@srno", "@proj_id", "@p_payment", "@pay_mode", "@ddate", "@Actiontype" };
                ...
                int i3 = dal.execute("ManagePartialPayment", col3, val3);
