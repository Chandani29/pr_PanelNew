...
public partial class Developer_all_activities : System.Web.UI.Page
{
    ...
    private void bindProjectList()
    {
        try
        {
            if (Session["developer_srno"] != null)
            {
                ...
                {
                    if (Request.Cookies["AllActivities"]["From"] == null)
                    {
                    ...
                    string roll;
                    roll = Request.Cookies["AllActivities"]["From"];
                    roll = roll + "," + Request.Cookies["AllActivities"]["To"];
                    ...
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        strProjectList += "<div align='center'><strong>All Activities:: From::" + strFrom + " To::" + strTo + "</strong></div></td></tr>";
                        ...
                        strProjectList += "<td><strong>Assigned Task</strong></td>";
                        strProjectList += "<td><strong>Assigned / Spent Hours</strong></td>";
                        strProjectList += "<td><strong>To Be Submmited By</strong></td>";
                        strProjectList += "<td><strong>Developers</strong></td>";
                        strProjectList += "<td><strong>Task Done By Developer</strong></td>";
                        strProjectList += "<td><strong>Task Status</strong></td>";
                        strProjectList += "</tr>";
                        ...
                        for (int j = 0; j < ds1.Tables[0].Rows.Count; j++)
                        {
                            ...
                            {
                                Balance_Hours = Math.Round((Balance_Hours + hourspend), 2);
                            ...
                            if (!string.IsNullOrEmpty(ds1.Tables[0].Rows[j]["inhouse_id"].ToString()))
                            {
                                ...
                                DataSet ds6 = dal.getDataSet("ManageProjectInhouse", col6, val6);
                            ...
                            strProjectList += "<td class='" + coror1 + "'>" + subcategory.ToString() + "&nbsp;</td>";
                            strProjectList += "<td class='" + coror1 + "'>" + hourspend + "&nbsp;</td>";
                            strProjectList += "<td class='" + coror1 + "'>" + ds1.Tables[0].Rows[j]["ur_date"].ToString() + "&nbsp;</td>";
                            ...
                            if (!string.IsNullOrEmpty(ds1.Tables[0].Rows[j]["work_by_mark"].ToString()))
                            {
                                if (!string.IsNullOrEmpty(ds1.Tables[0].Rows[j]["work_status"].ToString()))
                                {
                                    if (ds1.Tables[0].Rows[j]["work_status"].ToString() == "0")
                                    {
                                        if (ds2.Tables[0].Rows[0]["srno"].ToString() == Session["developer_srno"].ToString().Trim())
                                        {
                                            strProjectList += "<td class='" + coror1 + "'><font color='#FF0000'>Pending&nbsp;</font></td>";
                                        }
                                        else
                                        {
                                            strProjectList += "<td class='" + coror1 + "'>Pending&nbsp;</td>";
                                        }
                                    }
                                    else
                                    {
                                        strProjectList += "<td class='" + coror1 + "'>Done&nbsp;</td>";
                                    }
                                }
                                else
                                {
                                    strProjectList += "<td class='" + coror1 + "'>&nbsp;</td>";
                                }
                            }
                            else
                            {
                        ...
                        strProjectList += "<tr valign='top' bgcolor='#E6E6E6' class='tb2' > ";
                        strProjectList += "<td colspan='4' align='right' class='Tab2'>Balance Hours&nbsp;</td>";
                        strProjectList += "<td class='Tab3' align='left'>" + Balance_Hours + "&nbsp;</td>";
                        strProjectList += "<td colspan='4' align='right' class='Tab3'>&nbsp;</td>";
                        strProjectList += "</tr>";
